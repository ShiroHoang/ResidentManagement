    ...
    <div class="hero">
        <div class="form-container">
            <form action="RequestList" method="get">
                <input type="hidden" name="requestType" value="registerAddress">
                <table>
                    <tr>
                        <td><input type="submit" value="Xem đơn đề nghị đăng ký hộ khẩu"></td>
                    </tr>
                </table>
            </form>
            ...
            <form action="RequestList" method="get">
                ...
                <table>
                    <tr>
                        <td><input type="submit" value="Xem đơn đề nghị tách hộ khẩu"></td>
                    </tr>
                </table>
            </form>
            ...
            <form action="RequestList" method="get">
                ...
                <table>
                    <tr>
                        <td><input type="submit" value="Xem đơn đề nghị chuyển hộ khẩu"></td>
                    </tr>
                </table>
            </form>
